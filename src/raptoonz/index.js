// 10 AM / 2 PM / 6 PM CT RapToonz pin (Grok-generated rapper x cartoon-
// art-style mashup, pulled from #raptoonz). Invoked by
// src/raptoonz-cron.js (the GitHub Actions entry point, which gates the
